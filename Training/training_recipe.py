def set_settings(flags):
    flags.DEFINE_string('dataset', '../data/polyp_train.tfrecord', 'path to dataset')
    flags.DEFINE_string('val_dataset', '../data/polyp_valid.tfrecord', 'path to validation dataset')
    ...
    flags.DEFINE_integer('save_points', 1, 'save weights every')
